...
#include "APTimeManipulationSubsystem.generated.h"
...
/**
 *  @UAPTimeManipulationSubsystem
 * 
 *  게임 플레이의 시간 조작과 관련된 작업들을 처리하는 서브시스템
 */
UCLASS()
class ARCANEPUNK_API UAPTimeManipulationSubsystem : public UGameInstanceSubsystem, public FTickableGameObject
{
#pragma region Friend Class
    friend class UAPANS_ApplyTimeDilation;
#pragma endregion
