...
public:
	...
	void RegisterSpawnVolume(FName SpawnDataID, AAPSpawnVolume* SpawnVolume);
	AAPSpawnVolume* FindSpawnVolume(FName SpawnDataID);
...
private:
	...
	UPROPERTY() 
	TMap<FName, AAPSpawnVolume*> SpawnVolumes;
