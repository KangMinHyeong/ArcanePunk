...
public:
	...
	virtual void UpdateSkillSlot(AArcanePunkCharacter* Character, ESkillKey UpdateSkillKey, uint8 SkillNumber);
	...
	void UpdateSkillSlotImage(UTexture2D* SkillSlotImage);
