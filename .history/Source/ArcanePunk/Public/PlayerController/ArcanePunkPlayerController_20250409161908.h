...
public:
	...
	FORCEINLINE void ChangePlayer_0() {ChangeMainPlayer(0);};
	FORCEINLINE void ChangePlayer_1() {ChangeMainPlayer(1);};
	FORCEINLINE void ChangePlayer_2() {ChangeMainPlayer(2);};
	void ChangeMainPlayer(uint8 Index);
...
protected:
	...
	void SetSwitchingLocation(AArcanePunkCharacter* PriorCharacter, FVector & SwitchingLocation, FRotator & SwitchingRotation);
	void SwitchingPlayer(FVector Loc, FRotator Rot);
	void SwapPlayer();
