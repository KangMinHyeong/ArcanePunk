...
public:
	...
	FORCEINLINE void SwapPlayer_0() {ChangeMainPlayer(0);};
	FORCEINLINE void SwapPlayer_1() {ChangeMainPlayer(1);};
	FORCEINLINE void SwapPlayer_2() {ChangeMainPlayer(2);};
...
protected:
	...
	void SwapPlayer(FVector Loc, FRotator Rot);
	void SwapPlayer();
