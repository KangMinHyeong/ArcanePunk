...
protected:
	...
	virtual void EnemyDeadMotion() override;

public:
	virtual void Tick(float DeltaTime) override;

	virtual void RescueEnemy() override;
...
private:
	...
	UPROPERTY(EditAnywhere)
	TSubclassOf<AAPEnemyRescueBoat> RescueBoatClass;

	UPROPERTY(EditAnywhere)
	FVector RescueAddPoint = FVector(2000.0f, 0.0f ,0.0f);

	FVector RescueLocation = FVector(0.0f, 0.0f ,0.0f);
