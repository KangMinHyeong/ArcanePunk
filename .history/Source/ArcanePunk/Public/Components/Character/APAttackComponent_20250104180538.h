...
public:	
	...
	float ApplyDamage_ToActor(AActor* DamagedActor, float Damage, FHitResult HitResult, bool bCriticalApply, ECharacterState StateType = ECharacterState::None, float StateTime = 0.0f);
