...
{
	None		 	= 0 UMETA(DisplayName = "None"),
	Basic			= 1 UMETA(DisplayName = "None"),
	Timer		 	= 2 UMETA(DisplayName = "None"),
};
...
struct FSpawnStep
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(EditCondition="SpawnStepStartCondition == ESpawnStepStartCondition::PreviousSpawnStepFinish"))
	FName PreviousSpawnStepID;

	UPROPERTY(EditAnywhere)
	ESpawnStepType SpawnStepType;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(EditCondition="SpawnStepType == ESpawnStepType::Timer"))
	float TimerValue;
