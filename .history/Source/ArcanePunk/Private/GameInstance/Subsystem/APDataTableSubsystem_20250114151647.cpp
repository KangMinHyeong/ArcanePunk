...
{
    static ConstructorHelpers::FObjectFinder<UDataTable> SkillNameListData(TEXT("/Game/DataTable/Skill/SkillListData.SkillListData"));
	if(SkillNameListData.Succeeded()) SkillNameListDataTable = SkillNameListData.Object;

    static ConstructorHelpers::FObjectFinder<UDataTable> SkillAbilityRowData(TEXT("/Game/DataTable/Skill/SkillAbilityRowNameData.SkillAbilityRowNameData"));
	if(SkillAbilityRowData.Succeeded()) SkillAbilityRowDataTable = SkillAbilityRowData.Object;

    static ConstructorHelpers::FObjectFinder<UDataTable> SilverAbilityData(TEXT("/Game/DataTable/Skill/ArcanePunk_SkillAbilityData_Silver.ArcanePunk_SkillAbilityData_Silver"));
	if(SilverAbilityData.Succeeded()) SilverAbilityDataTable = SilverAbilityData.Object;

	static ConstructorHelpers::FObjectFinder<UDataTable> GoldAbilityData(TEXT("/Game/DataTable/Skill/ArcanePunk_SkillAbilityData_Gold.ArcanePunk_SkillAbilityData_Gold"));
	if(GoldAbilityData.Succeeded()) GoldAbilityDataTable = GoldAbilityData.Object;

    static ConstructorHelpers::FObjectFinder<UDataTable> PlatinumAbilityData(TEXT("/Game/DataTable/Skill/ArcanePunk_SkillAbilityData_Platinum.ArcanePunk_SkillAbilityData_Platinum"));
	if(PlatinumAbilityData.Succeeded()) PlatinumAbilityDataTable = PlatinumAbilityData.Object;

    static ConstructorHelpers::FObjectFinder<UDataTable> StringData(TEXT("/Game/DataTable/String/StringData.StringData"));
	if(StringData.Succeeded()) StringDataTable = StringData.Object;

    static ConstructorHelpers::FObjectFinder<UDataTable> DialogueData(TEXT("/Game/DataTable/String/DialogueData.DialogueData"));
	if(DialogueData.Succeeded()) DialogueDataTable = DialogueData.Object;

	static ConstructorHelpers::FObjectFinder<UDataTable> CharacterData(TEXT("/Game/DataTable/Character/CharacterData.CharacterData"));
	if(CharacterData.Succeeded()) CharacterDataTable = CharacterData.Object;

    static ConstructorHelpers::FObjectFinder<UDataTable> DropData(TEXT("/Game/DataTable/Character/DropData.DropData"));
	if(DropData.Succeeded()) DropDataTable = DropData.Object;

    static ConstructorHelpers::FObjectFinder<UDataTable> EquipData(TEXT("/Game/DataTable/Character/ItemData.ItemData"));
...
void UAPDataTableSubsystem::InitDialogueData()
{
    ...
    {
        FDialogueDataTable* Row = DialogueTable->FindRow<FDialogueDataTable>(RowName, TEXT("InitializeDialogueData"));
        if(Row)
        {
            ...
            else
            {
                ...
                GroupedDialogueRows.Emplace({Row->Diologue_ID, NewGroup});
            }
        }
    }
}