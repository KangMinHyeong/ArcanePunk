...
UAPDataTableSubsystem::UAPDataTableSubsystem()
{
    ...
    static ConstructorHelpers::FObjectFinder<UDataTable> SequenceStringData(TEXT("/Game/DataTable/String/SequenceStringData.SequenceStringData"));
	if(SequenceStringData.Succeeded()) SequenceStringDataTable = SequenceStringData.Object;
