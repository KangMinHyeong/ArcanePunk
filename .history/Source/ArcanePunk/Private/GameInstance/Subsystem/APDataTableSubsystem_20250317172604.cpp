...
#include "APDataTableSubsystem.h"
...
void UAPDataTableSubsystem::DisplaySystemMesseage(UAPDataTableSubsystem *DataTableGI, const FString &Message, bool bLowMessage, bool bWarning)
{
}
