...
void AArcaneReflector::OnReflectingCheck(float DeltaTime)
{
    ...
    {
        OwnerCharacter->GetAPHUD()->GetStatusWidget()->ChargeGauge( CurrentReflectTime - ChargeCurrent , ChargeMax );
...
void AArcaneReflector::SetSkill(const FSkillAbilityNestingData & SkillAbilityNestingData, USkillNumberBase* SkillComponent)
{
