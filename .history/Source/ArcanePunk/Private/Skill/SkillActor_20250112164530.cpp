...
void ASkillActor::UseSkill()
{
	...
	else if(SkillType == ESkillType::Charging)
	{
    	...
    	float Len = (HalfHeight * ChargingCoefficient) / 750.0f;
    	...
    	SkillEffectComponent->SetVariableVec3(TEXT("AddVector"),  FVector(((HalfHeight * ChargingCoefficient) - 750.0f) * 0.5f, 0.0f, 0.0f));
