...
USkillDataManager::USkillDataManager()
{
	...
	static ConstructorHelpers::FObjectFinder<UDataTable> AbilityData(TEXT("/Game/DataTable/Skill/AbilityDataTable.AbilityDataTable"));
	if(AbilityData.Succeeded()) AbilityDataTable = AbilityData.Object;
