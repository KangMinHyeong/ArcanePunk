...
{
	SpawnEffectComponent = CreateDefaultSubobject<UNiagaraComponent>(TEXT("SpawnEffectComponent"));

	SpawnEffectComponent->SetupAttachment(GetRootComponent());
}
