...
void UAPTutorialUI::NativeConstruct()
{
    ...
    if(TutorialGM.IsValid()) TutorialGM->OnEndedConversation.AddDynamic(this, &UAPTutorialUI::OnNextGuide);
}

void UAPTutorialUI::NativeDestruct()
{
    Super::NativeDestruct();

    if(TutorialGM.IsValid()) TutorialGM->OnEndedConversation.RemoveDynamic(this, &UAPTutorialUI::OnNextGuide);
}
...
void UAPTutorialUI::OnSwitchingGuide()
{
    ...
    case 1:
        ...
        GuideTextUI->InitOrder(101, true); // Guide UI 초기화
        break;
    ...
    case 8:
        ...
        OnFadeIn_GuideUI(); // Guide UI 애니메이션 재생
        GuideTextUI->InitOrder(102, true); // Guide UI 초기화
        break; 
    ...
    case 16:
        GetOwningPlayerPawn()->EnableInput(OwnerPC.Get()); 
        OnFadeIn_GuideUI(); // Guide UI 애니메이션 재생
        GuideTextUI->InitOrder(103, true); // Guide UI 초기화
    ...
    case 25:
        GetOwningPlayerPawn()->EnableInput(OwnerPC.Get()); 
        OnFadeIn_GuideUI(); // Guide UI 애니메이션 재생
        GuideTextUI->InitOrder(104, true); // Guide UI 초기화
        break; 
