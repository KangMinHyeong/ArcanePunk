...
FReply UAPTutorialUI::NativeOnMouseButtonDoubleClick( const FGeometry& InGeometry,const FPointerEvent& InMouseEvent ) // 전부 인벤토리로 (F키)
{
...
void UAPTutorialUI::OnSwitchingGuide()
{
    ...
    case 5:
        ...
        UAPDataTableSubsystem::SetTextBlock(UAPGameInstance::GetDataTableGI(GetWorld()),Text_Target, EStringRowName::Tutorial_Move); 
        break;
