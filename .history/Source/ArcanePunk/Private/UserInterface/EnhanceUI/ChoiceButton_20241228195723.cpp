...
void UChoiceButton::InitChoice(UUserWidget* UpdateParentWidget)
{
    ...
    auto DataTable = USkillDataManager::GetInstance()->GetAbilityDataTable()->FindRow<FSkillAbilityData>(SkillNumberName, SkillNumberName.ToString()); if(!DataTable) return;
