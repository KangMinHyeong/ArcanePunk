...
{
    UE_LOG(LogTemp, Display, TEXT("Your InitChoice"));
    bEnhance = true;
...
void UChoiceButton::ApplyChoice()
{
    ...
    if(bEnhance)
    {
        // Q,E SkillKey로 SkillController로 연결해서 적용하기
        OwnerCharacter->EnhanceSkill(ESkillKey::Q, AbilityIndex + 1);
        OwnerCharacter->EnhanceSkill(ESkillKey::E, AbilityIndex + 1);
