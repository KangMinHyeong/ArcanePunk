...
void UAPSkillSlot::StartSkillCoolTime(AArcanePunkCharacter* Character, ESkillKey UpdateSkillKey, float CoolTime)
{
    OwnerCharacter = Character; if(!OwnerCharacter) return;
