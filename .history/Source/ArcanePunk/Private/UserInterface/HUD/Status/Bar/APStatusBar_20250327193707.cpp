...
void UAPStatusBar::StartCoolTimeSlot(ESkillKey SkillKey, float CoolTime)
{
    ...
    {
        case ESkillKey::Q:
        Slot_QSkill->StartSkillCoolTime(OwnerCharacter, SkillKey, CoolTime);
        break;
    
        case ESkillKey::E:
        Slot_ESkill->StartSkillCoolTime(OwnerCharacter, SkillKey, CoolTime);
        break;

        case ESkillKey::R:
        Slot_RSkill->StartSkillCoolTime(OwnerCharacter, SkillKey, CoolTime);
        break;

        case ESkillKey::Dash:
        Slot_Dash->StartSkillCoolTime(OwnerCharacter, SkillKey, CoolTime);
        break;

        case ESkillKey::Parrying:
        Slot_Parrying->StartSkillCoolTime(OwnerCharacter, SkillKey, CoolTime);
        break;
    }
}
