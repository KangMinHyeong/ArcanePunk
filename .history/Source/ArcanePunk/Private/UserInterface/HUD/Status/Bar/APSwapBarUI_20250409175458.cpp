...
float UAPSwapBarUI::UpdateSwapGauge(uint8 PlayerID, float Add)
{
    return SwapUIs[PlayerID]->AddSwapGauge(Add); 
}

void UAPSwapBarUI::ClearSwapGauge(uint8 PlayerIndex)
{
    return SwapUIs[PlayerIndex]->ClearSwapGauge(); 
}