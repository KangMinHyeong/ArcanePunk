...
void UAPStatusBar::UpdateSkillSlot(AArcanePunkCharacter* Character, ESkillKey SkillKey, uint8 SkillNumber)
{
    switch (SkillKey)
    {
        case ESkillKey::Q:
        Slot_QSkill->UpdateSkillSlot(Character, SkillKey, SkillNumber);
        break;
    
        case ESkillKey::E:
        Slot_ESkill->UpdateSkillSlot(Character, SkillKey, SkillNumber);
        break;

        case ESkillKey::R:
        Slot_RSkill->UpdateSkillSlot(Character, SkillKey, SkillNumber);
        break;

        case ESkillKey::Dash:
        Slot_Dash->UpdateSkillSlot(Character, SkillKey, SkillNumber);
        break;

        case ESkillKey::Parrying:
        Slot_Parrying->UpdateSkillSlot(Character, SkillKey, SkillNumber);
        break;
    }
}
