...
void UAPStatusBar::SetHPPercent(AArcanePunkCharacter* Character, float Origin)
{
    APHPBar->SetHPPercent(Character, Origin);
}

float UAPStatusBar::UpdateSwapGauge(float Add)
{
    return APHPBar->AddSwapGauge(Add);
}

void UAPStatusBar::ClearSwapGauge()
{
    APHPBar->ClearSwapGauge();
}
...
void UAPStatusBar::StartCoolTimeSlot(ESkillKey SkillKey, float CoolTime)
{
    ...
    {
        case ESkillKey::Q:
        Slot_QSkill->StartSkillCoolTime(OwnerCharacter.Get(), SkillKey, CoolTime);
        break;
    
        case ESkillKey::E:
        Slot_ESkill->StartSkillCoolTime(OwnerCharacter.Get(), SkillKey, CoolTime);
        break;

        case ESkillKey::R:
        Slot_RSkill->StartSkillCoolTime(OwnerCharacter.Get(), SkillKey, CoolTime);
        break;

        case ESkillKey::Dash:
        Slot_Dash->StartSkillCoolTime(OwnerCharacter.Get(), SkillKey, CoolTime);
        break;

        case ESkillKey::Parrying:
        Slot_Parrying->StartSkillCoolTime(OwnerCharacter.Get(), SkillKey, CoolTime);
        break;
    }
}
