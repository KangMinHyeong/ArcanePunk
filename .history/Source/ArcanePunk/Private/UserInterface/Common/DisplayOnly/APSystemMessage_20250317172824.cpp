...
void UAPSystemMessage::DisplaySystemMesseage(const FString & Message, bool bLowMessage, bool bWarning)
{
    UAPDataTableSubsystem::SetTextBlock(UAPGameInstance::GetDataTableGI(GetWorld()),Text_Low, Message);
    UAPDataTableSubsystem::SetTextBlock(UAPGameInstance::GetDataTableGI(GetWorld()),Text_High, Message);
