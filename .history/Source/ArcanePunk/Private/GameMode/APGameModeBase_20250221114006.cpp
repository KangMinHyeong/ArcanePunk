...
void AAPGameModeBase::SpawnPlayers()
{
	...
	{
		auto Player = GetWorld()->SpawnActor<AMyCharacter>(PlayerPawnClass, SpawnLocation1, SpawnRotation);
	}
	AMyCharacter* MainPawn = GetWorld()->SpawnActor<AMyCharacter>(PlayerPawnClass, SpawnLocation1, SpawnRotation);
    if (MainPawn)
    {
