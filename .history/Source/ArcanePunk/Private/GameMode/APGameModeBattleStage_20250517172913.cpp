...
void AAPGameModeBattleStage::MonsterKilled(AActor* SpawnVolume)
{
    ...
    CheckBattleSection(SpawnVolume);	
}
...
void AAPGameModeBattleStage::CheckBattleSection(AActor* SpawnVolume)
{
...
void AAPGameModeBattleStage::StartPlay()
{
    ...
    auto APGI = Cast<UAPGameInstance>(GetWorld()->GetGameInstance());
    if(APGI)
    {
        APGI->InitData();
    }
