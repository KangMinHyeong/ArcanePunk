...
TArray<AEnemy_CharacterBase*> UAPSpawnMonsterComponent::SpawnMonsterRandomWithSquare(TSubclassOf<AEnemy_CharacterBase> SpawnMonsterClass, uint8 SpawnMonsterNum, const FVector & V_1, const FVector & V_2, const FVector & V_3, const FVector & V_4)
{
...
TArray<AEnemy_CharacterBase*> UAPSpawnMonsterComponent::SpawnMonsterRandomWithLocation(TSubclassOf<AEnemy_CharacterBase> SpawnMonsterClass, uint8 SpawnMonsterNum, const FVector & SpawnLocation)
{
    TArray<AEnemy_CharacterBase*> Enemies;
