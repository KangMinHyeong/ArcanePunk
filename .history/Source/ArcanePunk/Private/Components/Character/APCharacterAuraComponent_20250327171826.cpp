...
void UAPCharacterAuraComponent::BeginPlay()
{
	...
	AuraComp = UNiagaraFunctionLibrary::SpawnSystemAttached(AuraEffect, OwnerCharacter->GetMesh(), TEXT("AuraEffect"), OwnerCharacter->GetMesh()->GetComponentLocation(), OwnerCharacter->GetMesh()->GetComponentRotation(), EAttachLocation::KeepRelativeOffset, true);
}
