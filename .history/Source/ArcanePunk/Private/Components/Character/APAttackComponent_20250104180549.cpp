...
float UAPAttackComponent::ApplyDamage_ToActor(AActor* DamagedActor, float Damage, FHitResult HitResult, bool bCriticalApply, ECharacterState StateType, float StateTime)
{
