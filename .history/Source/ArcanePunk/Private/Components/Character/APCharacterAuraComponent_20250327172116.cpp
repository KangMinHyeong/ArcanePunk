...
void UAPCharacterAuraComponent::BeginPlay()
{
	...
	AuraComp = UNiagaraFunctionLibrary::SpawnSystemAtLocation(GetWorld(), AuraEffect, OwnerCharacter->GetMesh()->GetComponentLocation(), OwnerCharacter->GetMesh()->GetComponentRotation(), FVector(1.0f, 1.0f, 1.0f), false);
	// AuraComp = UNiagaraFunctionLibrary::SpawnSystemAttached(AuraEffect, OwnerCharacter->GetMesh(), TEXT("AuraEffect"), OwnerCharacter->GetMesh()->GetComponentLocation(), OwnerCharacter->GetMesh()->GetComponentRotation(), EAttachLocation::KeepRelativeOffset, false);
}
