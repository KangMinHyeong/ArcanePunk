...
void AArcanePunkCharacter::DeadPenalty(float DeathTime)
{
	...
	float RT = UGameplayStatics::GetRealTimeSeconds(GetWorld());
	UE_LOG(LogTemp, Display, TEXT("Your RT - APGI->GetSavedRealTime() %f"), RT - APGI->GetSavedRealTime());
	MyGameStatus.SaveRealTime += RT - APGI->GetSavedRealTime(); APGI->SetSavedRealTime(RT);
	UE_LOG(LogTemp, Display, TEXT("Your DeadPenalty.SaveRealTime %f"), MyGameStatus.SaveRealTime);
...
void AArcanePunkCharacter::InitPlayerStatus()
{
	...
	UE_LOG(LogTemp, Display, TEXT("Your MyGameStatus.SaveRealTime %f"), MyGameStatus.SaveRealTime);
