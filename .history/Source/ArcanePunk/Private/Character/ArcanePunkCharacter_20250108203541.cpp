...
void AArcanePunkCharacter::UseSkill(ESkillKey SkillKey)
{
    ...
    {
    case ESkillKey::Q:
		UE_LOG(LogTemp, Display, TEXT("Your UseSkill"));
		OnQSkill = true;
        break;
    case ESkillKey::E:
        OnESkill = true;
...
void AArcanePunkCharacter::EnableSkillTest(bool Enable)
{
	...
	if(Enable)
	{
		...
		InputComponent->BindAction(TEXT("Skill_E"), EInputEvent::IE_Released, this, &AArcanePunkCharacter::Release_Q);
		...
		InputComponent->BindAction(TEXT("Skill_R"), EInputEvent::IE_Released, this, &AArcanePunkCharacter::Release_Q);
	}
	else
	{
		InputComponent->BindAction(TEXT("Skill_Q"), EInputEvent::IE_Pressed, this, &AArcanePunkCharacter::SkillBase_Q);
