...
void AArcanePunkPlayerController::SetupInputComponent()
{
    ...
    InputComponent->BindAction(TEXT("ChangePlayer_0"), EInputEvent::IE_Pressed, this, [this]() {
        ChangeMainPlayer(0); 
    });
    InputComponent->BindAction(TEXT("ChangePlayer_1"), EInputEvent::IE_Pressed, this, [this]() {
        ChangeMainPlayer(1); 
    });
    InputComponent->BindAction(TEXT("ChangePlayer_2"), EInputEvent::IE_Pressed, this, [this]() {
        ChangeMainPlayer(2); 
    });
}
