...
void AArcanePunkPlayerController::SetupInputComponent()
{
    ...
    InputComponent->BindAction(TEXT("ChangePlayer_1"), EInputEvent::IE_Pressed, this, [this]() {
        ChangeMainPlayer(1); 
    });
    InputComponent->BindAction(TEXT("ChangePlayer_2"), EInputEvent::IE_Pressed, this, &AArcanePunkPlayerController::ChangeMainPlayer);
    InputComponent->BindAction(TEXT("ChangePlayer_3"), EInputEvent::IE_Pressed, this, &AArcanePunkPlayerController::ChangeMainPlayer);
}
