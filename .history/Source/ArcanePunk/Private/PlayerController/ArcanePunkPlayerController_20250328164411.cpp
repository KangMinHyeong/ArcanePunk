...
void AArcanePunkPlayerController::PlayerTick(float DeltaTime)
{
    ...
    if(bSwap)
    {
        ...
        SwapSlow = FMath::FInterpConstantTo(SwapSlow, 0.5f, DeltaTime, SwapDelayTime);
        UE_LOG(LogTemp, Display, TEXT("SwapSlow %f"), SwapSlow);
...
void AArcanePunkPlayerController::ChangeMainPlayer(uint8 Index)
{
    ...
    PriorCharacter->SwitchingMainPlayer(false);
