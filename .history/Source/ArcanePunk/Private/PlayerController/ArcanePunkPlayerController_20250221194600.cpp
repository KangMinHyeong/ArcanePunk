...
{
    UNiagaraFunctionLibrary::SpawnSystemAtLocation(GetWorld(), SwitchingEffect, OwnerCharacter->GetLeftBeamPoint()->GetComponentLocation(), OwnerCharacter->GetActorRotation());
