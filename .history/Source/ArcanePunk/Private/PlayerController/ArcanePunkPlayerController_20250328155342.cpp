...
void AArcanePunkPlayerController::SetSwitchingLocation(AArcanePunkCharacter* PriorCharacter, FVector & SwitchingLocation, FRotator & SwitchingRotation)
{
    ...
    float Dist;
    UGameplayStatics::FindNearestActor(PriorCharacter->GetActorLocation(), Enemies, Dist);
    ...
    {
        SwitchingLocation = MyCharacter->GetActorLocation() + FVector(AttackRange, 0.0f, 0.0f);
        SwitchingRotation = MyCharacter->GetActorRotation(); 
    }
}
